...
//		System.out.println(dao.selectOrderById(id));
		
		request.setAttribute("order",dao.selectOrderById(id) );
		request.getRequestDispatcher("../page/ordermodify.jsp").forward(request, response);;
