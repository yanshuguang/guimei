...
public class Goods_classModifyServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Goods_class gs=dao.selectById(id);
		request.setAttribute("gs", gs);
		
		request.getRequestDispatcher("../page/goods_classmodify.jsp").forward(request, response);
