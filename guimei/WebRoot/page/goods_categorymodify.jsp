...
<body>
	...
	<form action="servlet/Goods_categoryUpdateServlet" method="post">
	<input type="text" name="id" value="${gc.category_id }" style="display: none">
		<table>
			<tr>
				<td>商品类别名称（*）：</td>
				<td><input type="text" name="category_name" value="${gc.category_name }"></td>
			</tr>
			<tr>
				<td>所属大分类：</td>
